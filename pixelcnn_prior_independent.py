...
from pixelcnn_mixed.modules import IndependentMixedPixelCNNPrior
...
def main(argv=None):
    parser = argparse.ArgumentParser(description='Independent class-conditional Gated PixelCNN priors for mixed-curvature VQ-VAE.')
    ...
    prior = IndependentMixedPixelCNNPrior(codebook_sizes=codebook_sizes, hidden_size=args.hidden_size_prior, n_layers=args.num_layers, n_classes=num_classes).to(device)

    prior_checkpoint = args.prior_checkpoint or os.path.join(args.output_dir, 'independent_prior_best.pt')
    ...
    save_json(metadata, os.path.join(args.output_dir, 'independent_prior_meta.json'))
    ...
    if args.generate_only:
        ...
        sample_and_save(prior, model, preview_labels, device, latent_shape, os.path.join(args.output_dir, 'independent_prior_samples.png'))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(f'[independent prior] epoch={epoch:03d} train_loss={train_metrics["loss"]:.6f} valid_loss={valid_metrics["loss"]:.6f} time={time.time() - start:.1f}s')
        ...
        sample_and_save(prior, model, preview_labels, device, latent_shape, os.path.join(args.output_dir, f'independent_prior_samples_epoch_{epoch:03d}.png'))
...
# python pixelcnn_prior_independent.py --model-dir=/mnt/data/lkm/data/reMcVQVAE_results/ablation/test/2026-03-21_14-15-16_cifar10_vqcvae_h128_k128_emb64_noema --output-dir=/mnt/data/lkm/data/reMcVQVAE_results/ablation/test/2026-03-21_14-15-16_cifar10_vqcvae_h128_k128_emb64_noema/prior_independent --epochs=20 --device=cuda:1

# python pixelcnn_prior_independent.py --model-dir=/mnt/data/lkm/data/reMcVQVAE_results/ablation/test/2026-03-21_14-15-16_cifar10_vqcvae_h128_k128_emb64_noema --output-dir=/mnt/data/lkm/data/reMcVQVAE_results/ablation/test/2026-03-21_14-15-16_cifar10_vqcvae_h128_k128_emb64_noema/prior_independent --prior-checkpoint=/mnt/data/lkm/data/reMcVQVAE_results/ablation/test/2026-03-21_14-15-16_cifar10_vqcvae_h128_k128_emb64_noema/prior_independent/independent_prior_best.pt --generate-only --sample-count=16 --fid-real-count=1000 --fid-generated-count=1000
